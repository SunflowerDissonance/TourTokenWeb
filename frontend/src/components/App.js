...
function app() {
    return __awaiter(this, void 0, void 0, function () {
        var accountInteraction, selectedAddress, dePoolAddress, dePool, transaction, output, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ever.hasProvider()];
                case 1:
                    if (!(_a.sent())) {
                        throw new Error('Extension is not installed');
                    }
                    return [4 /*yield*/, ever.requestPermissions({
                ...
                case 2:
                    ...
                    dePoolAddress = new everscale_inpage_provider_1.Address('0:bbcbf7eb4b6f1203ba2d4ff5375de30a5408a8130bf79f870efbcfd49ec164e9');
                    dePool = new ever.Contract(DePoolAbi, dePoolAddress);
                    return [4 /*yield*/, dePool
                            .methods
                            .addOrdinaryStake({
                            stake: '10000000000',
                        }).send({
                ...
                case 6:
                    e_1 = _a.sent();
                    if (e_1 instanceof everscale_inpage_provider_1.TvmException) {
...
var DePoolAbi = {
    ...
    'data': [],
    'events': [],
}; // NOTE: `as const` is very important here
